  ...
  return (
    <>
      <section className="w-full mx-auto">
        ...
        <ul className="flex justify-between flex-col px-10 mx-auto m-4 p-5 rounded-xl w-3/4">
          {posts.map((item) => (
            <li className="mb-4 break-all p-6 border-4 border-y-black border-x-transparent">
              ...
              <p className="mb-4 mt-2 overflow-visible">
                {item.content}
              </p>
              ...
              {item.author ? (
                <a className="mb-4 mt-2 cursor-pointer">
                  By {item.author}
                </a>
              ) : (
                <div className="mb-4 mt-2 cursor-pointer">
                  By Deleted User
                </div>
              )}
            </li>
